...
- **Vue liste** sous forme de grille de cartes, une par bien, avec :
  ...
  - suppression d'un bien directement depuis la carte, avec confirmation en deux étapes (voir ci-dessous).
...
- **Import de brouillons** : ajout aux brouillons existants, ou remplacement total. Le remplacement total étant destructif **et partagé** (il supprime les brouillons de tous les agents, pas seulement de cet appareil), il exige une confirmation en deux étapes : il faut retaper le mot « REMPLACER » dans un champ dédié avant que le bouton de confirmation ne s'active.
